                    ...
                    {selectedCars[car._id] && (
                        <div>
                            <input
                                ...
                                onChange={(e) => handleInputChange(car._id, 'make', e.target.value)}
                            />
                            <input
                                type="text"
                                placeholder="Model"
                                value={formValues[car._id]?.model || car.model}
                                onChange={(e) => handleInputChange(car._id, 'model', e.target.value)}
                            />
                            <input
                                type="text"
                                placeholder="Owner"
                                value={formValues[car._id]?.owner || car.owner}
                                onChange={(e) => handleInputChange(car._id, 'owner', e.target.value)}
                            />
                            <input
                                type="text"
                                placeholder="Color"
                                value={formValues[car._id]?.color || car.color}
                                onChange={(e) => handleInputChange(car._id, 'color', e.target.value)}
                            />
                            <input
                                type="text"
                                placeholder="Registration number"
                                value={formValues[car._id]?.registration_number || car.registration_number}
                                onChange={(e) => handleInputChange(car._id, 'registration_number', e.target.value)}
                            />
                            <input
                                type="text"
                                placeholder="address"
                                value={formValues[car._id]?.address || car.address}
                                onChange={(e) => handleInputChange(car._id, 'address', e.target.value)}
                            />
                        </div>
                    )}
                </li>
